...
const AnalyticsTable = () => {
  return (
    <div className="flex flex-col h-full w-full p-10 ">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mx-auto max-w-screen-xl bg-yellow-200">
        <div className="bg-black rounded-lg p-4 shadow-lg text-white flex flex-col space-y-4">
          ...
          <div className="flex-1 overflow-auto max-h-64"> {/* Use Tailwind CSS classes for height */}
